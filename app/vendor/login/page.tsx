...
import { vendorSignIn } from "@/lib/partner/auth";
      ...
      <aside className="relative isolate hidden flex-col justify-between overflow-hidden bg-[#006E42] px-12 py-12 text-[#e6efe9] lg:flex">
        ...
        >
          ...
          <h2 className="mt-5 text-[44px] font-bold leading-[1.04] tracking-tight text-white">
            Your catalogue.
            <br />
            <span className="text-[#9af2c4]">Always in stock.</span>
          </h2>
          <p className="mt-5 max-w-md text-[14px] leading-relaxed text-white/75">
            List your products, manage stock and pricing, and track every order,
          ...
          <div className="mt-9 grid grid-cols-3 gap-3">
            {[
              { label: "Avg. orders / week", value: "42" },
              ...
              >
                <p className="text-[10px] uppercase tracking-[0.12em] text-white/55">{s.label}</p>
                <p className="mt-1 text-[20px] font-bold tabular-nums text-white">{s.value}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <blockquote className="text-[14px] leading-relaxed text-white/85">
            &quot;Listing a new SKU used to mean emails and spreadsheets. Now it is
            a two minute request, and payouts land like clockwork.&quot;
          </blockquote>
          <figcaption className="mt-2 text-[11.5px] text-white/55">
            Rhea Malhotra · Ops lead, MuscleBlaze Nutrition
          </figcaption>
        </motion.figure>
      </aside>
      ...
      <main className="flex items-center justify-center px-6 py-14 lg:px-12">
        ...
        >
          ...
          <form onSubmit={onSubmit} className="mt-8 space-y-4">
            <Field
              id="username"
              label="Vendor username or brand"
              icon={Store}
              value={username}
              onChange={setUsername}
              placeholder="muscleblaze.vendor"
            ...
            <div className="flex items-center justify-between pt-1 text-[11.5px]">
              ...
              <a href="#" className="font-medium text-[#006E42] hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            >
              {busy ? "Opening your catalogue…" : "Sign in"}
          ...
          <div className="mt-7 border-t border-[#0f3a26]/8 pt-5">
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-[13px] font-semibold text-[#0f3a26]">Join our vendor network</p>
                <p className="text-[11.5px] leading-relaxed text-[#0f3a26]/60">
                  Sell your catalogue on SuppAI. Apply in a few minutes.
                </p>
              </div>
...
function Field({
  ...
  return (
    <div>
      <label htmlFor={id} className="mb-1.5 block text-[11.5px] font-semibold text-[#0f3a26]">
        {label}
      </label>
